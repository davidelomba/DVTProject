...
SCENARIOS = [
    ...
    {
        "id": "SYN_31_diagnosis_no_details_upper",
        "description": "Diagnosi di TVP dell'arto superiore riferita senza dettagli -- F='Yes', arto superiore",
        "facts": [
            "Paziente uomo, 54 anni",
            "Inviato dallo specialista angiologo con diagnosi di trombosi venosa profonda dell'arto superiore destro",
            "Non sono disponibili in questa sede referti, esami obiettivi o accertamenti a supporto della diagnosi",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_32_discharge_letter_dvt",
        "description": "Lettera di dimissione che riporta la TVP come diagnosi, senza alcun dettaglio -- F='Yes'",
        "facts": [
            "Paziente donna, 71 anni",
            "Lettera di dimissione da altro reparto che riporta come diagnosi di dimissione trombosi venosa profonda dell'arto inferiore destro",
            "La lettera non riporta sintomi, esame obiettivo, esami di laboratorio ne' referti di imaging",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_33_transfer_note_dvt_upper",
        "description": "Nota di trasferimento con diagnosi di TVP dell'arto superiore, priva di dettagli -- F='Yes', arto superiore",
        "facts": [
            "Paziente uomo, 38 anni",
            "Nota di trasferimento interospedaliero con diagnosi di trombosi venosa profonda dell'arto superiore sinistro",
            "Nella nota non compaiono descrizioni cliniche, parametri, esami di laboratorio o accertamenti strumentali",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_34_dvt_reported_other_facility",
        "description": "Diagnosi di TVP posta presso altra struttura e riferita senza alcun dettaglio -- F='Yes'",
        "facts": [
            "Paziente donna, 66 anni",
            "Riferita con diagnosi di trombosi venosa profonda dell'arto inferiore sinistro posta presso altra struttura",
            "Non e' pervenuta alcuna documentazione clinica, di laboratorio o strumentale a supporto della diagnosi",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_35_specialist_note_dvt_lower",
        "description": "Nota ambulatoriale che elenca la TVP fra le diagnosi attive senza dettagli -- F='Yes'",
        "facts": [
            "Paziente uomo, 47 anni",
            "Nota ambulatoriale dello specialista che elenca fra le diagnosi attive una trombosi venosa profonda dell'arto inferiore destro",
            "La nota non contiene anamnesi, esame obiettivo, esami ematochimici ne' accertamenti strumentali relativi a tale diagnosi",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_40_imaging_report_pending",
        "description": "Ecografia eseguita in pronto soccorso con referto non ancora disponibile -- unico caso di A3.1 'done but results unknown' con sintomi documentati",
        "facts": [
            "Paziente uomo, 51 anni",
            "Da 2 giorni dolore al polpaccio destro ed edema dell'arto inferiore destro",
            "Eseguita ecografia venosa dell'arto inferiore destro in pronto soccorso; al momento della compilazione il referto non e' ancora disponibile e l'esito non e' noto",
            "D-dimero: 1.900 ng/mL, superiore al limite superiore di riferimento del laboratorio",
            "Nessuna diagnosi riferita da specialista",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
    ...
    {
        "id": "SYN_36_calf_muscle_tear",
        "description": "Strappo del gastrocnemio che mima una TVP -- diagnosi alternativa da Tabella 2, ramo trauma fisico",
        "facts": [
            "Paziente uomo, 34 anni, dolore acuto al polpaccio destro insorto durante attivita' sportiva",
            "Da 2 giorni dolore e tumefazione del polpaccio destro",
            "Ecografia dell'arto inferiore destro: vene comprimibili, nessuna evidenza di trombosi venosa profonda",
            "La stessa ecografia documenta una lesione parziale del muscolo gastrocnemio mediale con raccolta ematica",
            "Diagnosi dello specialista: strappo muscolare del gastrocnemio destro",
            "D-dimero non eseguito",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
    ...
    {
        "id": "SYN_37_lymphatic_obstruction",
        "description": "Linfedema secondario che mima una TVP -- diagnosi alternativa da Tabella 2, ostruzione linfatica",
        "facts": [
            "Paziente donna, 63 anni, pregressa linfoadenectomia inguinale per neoplasia",
            "Da 3 settimane edema progressivo dell'arto inferiore sinistro, senza dolore",
            "Ecocolordoppler venoso arto inferiore sinistro: flusso regolare, nessuna evidenza di trombosi venosa profonda",
            "D-dimero: 280 ng/mL, entro il range di normalita' del laboratorio",
            "Diagnosi dello specialista: linfedema secondario da ostruzione linfatica",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
            ...
            "b1_1": {"answer": "\u22651 symptom or sign of DVT was reported"},
            "b1_2": {"types": []},
            "b2": {"symptoms": ["Leg swelling or pitting oedema"]},
            "c": {"answer": "D-dimer tested and was within test lab's range of normal"},
            "f": {"answer": "No"},
            "x": {"answer": "An alternative diagnosis was found that explained the acute illness"},
        },
    ...
    {
        "id": "SYN_38_compartment_syndrome",
        "description": "Sindrome compartimentale con polsi assenti all'esame obiettivo -- diagnosi alternativa da Tabella 2, e unico caso di polsi assenti verificati clinicamente",
        "facts": [
            "Paziente uomo, 29 anni, trauma contusivo alla gamba sinistra 12 ore prima",
            "Dolore intenso e tumefazione tesa del polpaccio sinistro",
            "All'esame obiettivo i polsi pedidio e tibiale posteriore sinistri non sono apprezzabili",
            "Ecocolordoppler venoso arto inferiore sinistro: vene pervie, nessuna evidenza di trombosi venosa profonda",
            "Misurazione della pressione intracompartimentale elevata; diagnosi di sindrome compartimentale della loggia posteriore",
            "D-dimero non eseguito",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
    ...
    {
        "id": "SYN_39_external_vein_compression",
        "description": "Compressione estrinseca della vena iliaca da massa pelvica -- diagnosi alternativa da Tabella 2, esercita la keyword aggiunta di recente",
        "facts": [
            "Paziente donna, 58 anni",
            "Da 10 giorni edema dell'arto inferiore destro, senza dolore ne' arrossamento",
            "TC addome-pelvi: voluminosa massa pelvica che determina compressione esterna della vena iliaca esterna destra",
            "Ecocolordoppler venoso arto inferiore destro: assenza di trombosi venosa profonda",
            "D-dimero: 340 ng/mL, entro il range di normalita' del laboratorio",
            "Diagnosi dello specialista: edema da compressione venosa estrinseca da massa pelvica",
            "Nessuna autopsia o intervento chirurgico recente",
        ],
        "ground_truth": {
            "a1": {"answer": "No autopsy done, unknown if done, or done but results unavailable"},
